...
export function OsiPanel({ profile, selected }: OsiPanelProps): React.JSX.Element {
  ...
  return (
    <div className="osi-panel" role="group" aria-label="Perfil de capas OSI">
      ...
      <div style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 4 }}>
        {OSI_LABELS.map((l) => {
          ...
          return (
            ...
            >
              ...
              <span className="mono" aria-hidden="true" style={{ color: 'var(--text-primary)', fontSize: 'var(--font-size-xs)' }}>
                TCP/IP {l.tcpIp}
              </span>
              {termina ? (
